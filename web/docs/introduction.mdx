...
**Zuord** (German for 'assign' or 'map') is a TypeScript library focused on deep object manipulations and type inferences, providing full synchronization between runtime functions and compile-time types. This means what you write at runtime will always reflect exactly in your types — and vice versa.
