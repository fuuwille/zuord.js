...
export declare namespace Merge {
    ...
    export type BuildPlain<TContent, TMode extends Core.Mode.Field> = (
        TContent extends Type.TupleLast<infer TRest extends Type.Plain[], infer TLast extends Type.Plain> ? (
    ...
    export type BuildArray<TContent, TMode extends Core.Mode.Field> = (
        TContent extends Type.TupleLast<infer TRest extends Type.Array[], infer TLast extends Type.Array> ? (
            TRest["length"] extends 0 ? TLast : 
