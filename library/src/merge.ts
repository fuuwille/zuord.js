...
export function merge <TContent extends ZuordType.TupleLike<ZuordType.Plain>> (content: [...TContent]) 
    : Merge<TContent>;

export function merge <TContent extends ZuordType.TupleLike<ZuordType.Plain>, TMode extends Partial<MergeMode>> (content: [...TContent], mode: TMode)
