 ...
 * @throws {TypeError} If either `base` or `input` is not a valid plain.
 */
function plainStrict <TBase extends Type.Plain, TInput extends Util.Strict.Keys<TBase, TInput>> (base: TBase, input: TInput)
 ...
 * @throws {TypeError} If `mode` is not a valid mode.
 */
function plainStrict <TBase extends Type.Plain, TInput extends Util.Strict.Keys<TBase, TInput>, TMode extends Partial<Mode.Integrate>> (base: TBase, input: TInput, mode: TMode)
    : Integrate.PlainStrict<TBase, TInput, TMode>;

function plainStrict <TBase extends Type.Plain, TInput extends Util.Strict.Keys<TBase, TInput>, TMode extends Partial<Mode.Integrate>> (base: TBase, input: TInput, mode: TMode = {} as TMode)
