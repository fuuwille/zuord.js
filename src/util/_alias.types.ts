...
import type { ZuordIs, ZuordIsAny, ZuordIsEvery, ZuordIsSome, ZuordIsToEvery, ZuordIsAnyToAny, ZuordIsAnyToEvery, ZuordIsEveryToAny, ZuordIsEveryToEvery } from "./is.types";
