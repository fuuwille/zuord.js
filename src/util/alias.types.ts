...
import type { ZuordIsObject, ZuordIsPlainObject, ZuordHasPlainObject, ZuordHasNonPlainObject, ZuordAsPlainObject, ZuordAsNonPlainObject } from "./object.types";
...
export namespace ZuordUtil {
    ...
    export type HasPlainObject<T> = ZuordHasPlainObject<T>;
    export type HasNonPlainObject<T> = ZuordHasNonPlainObject<T>;
    export type AsPlainObject<T> = ZuordAsPlainObject<T>;
    export type AsNonPlainObject<T> = ZuordAsNonPlainObject<T>;
