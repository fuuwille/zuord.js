...
import type { ZuordIsTuple, ZuordIsSomeTuple, ZuordIsAllTuple, ZuordHasTuple, ZuordHasSomeTuple, ZuordHasAllTuple, ZuordExtractTuple } from "./tuple.types";
...
export namespace ZuordUtil {
  ...
  export type ToPlainWithOptions<T, Options extends Zuord.Options = Zuord.DefaultOptions> = ZuordToPlainWithOptions<T, Options>;
