import type { ZuordNormalizeIgnore } from "./normalize.types";
...
import type { ZuordIsPlain, ZuordHasPlain, ZuordHasNonPlain, ZuordAsPlain, ZuordAsNonPlain } from "./plain.types";
