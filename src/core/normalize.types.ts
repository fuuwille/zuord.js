...
type Normalize<T, L extends ZuordUtil.Ignore = ZuordUtil.Ignore > = ZuordUtil.CanIgnore<T, L> extends true ? (
...
type NormalizeDirect<T, L extends ZuordUtil.Ignore = ZuordUtil.Ignore > = ZuordUtil.CanIgnore<T, L> extends true ? (
