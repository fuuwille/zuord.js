...
function mergeBy<U extends object[], const M extends Zuord.MergeMode[] = Zuord.MergeDefaultMode>({ content, mode } : Zuord.MergeData<U, M> ): Zuord.Merge<U, Zuord.MergeResolveOptions<{ mode: M }, Zuord.MergeDefaultOptions>> {
    if (content.length === 0) {
