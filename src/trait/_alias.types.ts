...
import type { ZuordEqBigInt, ZuordEqSomeBigInt, ZuordEqAllBigInt, ZuordIsBigInt, ZuordIsSomeBigInt , ZuordIsAllBigInt, ZuordHasBigInt, ZuordHasSomeBigInt, ZuordHasAllBigInt, ZuordExcludeBigInt, ZuordExcludeExactBigInt, ZuordExtractBigInt } from "./06_bigint.types";
