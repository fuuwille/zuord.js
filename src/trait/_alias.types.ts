...
import type { ZuordEqBigInt, ZuordEqSomeBigInt, ZuordEqAllBigInt, ZuordIsBigInt, ZuordIsSomeBigInt , ZuordIsAllBigInt, ZuordHasBigInt, ZuordHasSomeBigInt, ZuordHasAllBigInt, ZuordExcludeBigInt, ZuordExcludeExactBigInt, ZuordExtractBigInt, ZuordExtractExactBigInt } from "./06_bigint.types";
...
export namespace ZuordTrait {
  ...
  export type EqSomeBoolean<U extends readonly unknown[]> = ZuordEqSomeBoolean<U>;

  export type EqAllBoolean<U extends readonly unknown[]> = ZuordEqAllBoolean<U>;
  ...
  export type ExcludeExactBoolean<T> = ZuordExcludeExactBoolean<T>;
  ...
  export type IsBigInt<T> = ZuordIsBigInt<T>;

  export type IsSomeBigInt<U extends readonly unknown[]> = ZuordIsSomeBigInt<U>;

  export type IsAllBigInt<U extends readonly unknown[]> = ZuordIsAllBigInt<U>;

  export type HasBigInt<T> = ZuordHasBigInt<T>;

  export type HasSomeBigInt<U extends readonly unknown[]> = ZuordHasSomeBigInt<U>;

  export type HasAllBigInt<U extends readonly unknown[]> = ZuordHasAllBigInt<U>;

  export type ExcludeBigInt<T> = ZuordExcludeBigInt<T>;

  export type ExcludeExactBigInt<T> = ZuordExcludeExactBigInt<T>;

  export type ExtractBigInt<T> = ZuordExtractBigInt<T>;

  export type ExtractExactBigInt<T> = ZuordExtractExactBigInt<T>;
