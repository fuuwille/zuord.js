...
[T, ZuordCore.ModeResolve<[TMode, { "$one.all": true }]>] extends [infer TPlain extends ZuordType.Plain, infer THybridMode extends ZuordCore.ModeRecord] ? (
...
export type ResolveRequired<T, TMode extends ZuordCore.ModeRecord> = [ZuordTrait.Is.Base<T, ZuordType.Plain>] extends [true] ? {
...
export type ResolveOptional<T, TMode extends ZuordCore.ModeRecord> = [ZuordTrait.Is.Base<T, ZuordType.Plain>] extends [true] ? {
