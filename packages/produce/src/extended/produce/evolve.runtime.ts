...
export function restrict <TSource extends ZuordType.Plain, TPatches extends ZuordUtil.Restrict.KeysBatch<TSource, TPatches>, TMode extends Partial<ProduceModeX.Evolve.Restrict>> (source: TSource, patches: [...TPatches], mode: TMode)
    : ProduceX.Evolve.Restrict<TSource, TPatches, TMode>;

export function restrict <TSource extends ZuordType.Plain, TPatches extends ZuordUtil.Restrict.KeysBatch<TSource, TPatches>, TMode extends Partial<ProduceModeX.Evolve.Restrict>> (source: TSource, patches: [...TPatches], mode: TMode = {} as TMode)
