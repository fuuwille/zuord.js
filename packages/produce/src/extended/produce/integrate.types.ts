...
export type Loose<TSource extends ZuordType.Plain, TContent extends ZuordType.Plain, TMode extends Partial<ProduceModeX.Integrate.Loose> = {}> 
    = $Produce.Integrate.Plain<TSource, TContent, ZuordCore.ModeResolve<[typeof produceModeX.integrate.loose, TMode]>>;

export type Restrict<TSource extends ZuordType.Plain, TPatch extends ZuordUtil.Restrict.Keys<TSource, TPatch>, TMode extends Partial<ProduceModeX.Integrate.Restrict> = {}> 
    = $Produce.Integrate.Plain<TSource, TPatch, ZuordCore.ModeResolve<[typeof produceModeX.integrate.restrict, TMode]>>;

export type Array<TSource extends ZuordType.Array, TContent extends ZuordType.Array, TMode extends Partial<ProduceModeX.Integrate.Array> = {}> 
