...
Zuord provides a modern **TypeScript-first** library for producing **new objects** from existing ones, without **mutating inputs**.
It offers a variety of producers usable both at **runtime** and at the **type-level**, forming a **synchronized API** across both.
