...
type Test1Sample = Zuord.ImposeLoose<{ a: number }, never, { a: 222 }>;
...
type Test2Sample = Zuord.ImposeLoose<{ a: number }, undefined, { a: 222 }>;
...
type Test3Sample = Zuord.ImposeLoose<{ a: number; b: string }, { a: 7 }, { a: 222; b: "test" }>;
