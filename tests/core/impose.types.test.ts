...
type Test1Sample = Zuord.ImposeLooseBase<{ a: number }, never, { a: 222 }>;
...
type Test2Sample = Zuord.ImposeLooseBase<{ a: number }, undefined, { a: 222 }>;
...
type Test3Sample = Zuord.ImposeLooseBase<{ a: number; b: string }, { a: 7 }, { a: 222; b: "test" }>;
