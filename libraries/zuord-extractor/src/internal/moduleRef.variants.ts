...
import { isModuleFunctionLikeNode, isModuleFunctionNode, isModuleSchemaNode, isModuleVariableNode, isModuleVariantNode } from "./moduleNode.variants";
